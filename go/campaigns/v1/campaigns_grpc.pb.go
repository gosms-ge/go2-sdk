...
const (
	CampaignService_ListCampaigns_FullMethodName     = "/campaigns.v1.CampaignService/ListCampaigns"
	CampaignService_CreateCampaign_FullMethodName    = "/campaigns.v1.CampaignService/CreateCampaign"
	CampaignService_GetCampaign_FullMethodName       = "/campaigns.v1.CampaignService/GetCampaign"
	CampaignService_UpdateCampaign_FullMethodName    = "/campaigns.v1.CampaignService/UpdateCampaign"
	CampaignService_DeleteCampaign_FullMethodName    = "/campaigns.v1.CampaignService/DeleteCampaign"
	CampaignService_GenerateLinks_FullMethodName     = "/campaigns.v1.CampaignService/GenerateLinks"
	CampaignService_ListCampaignLinks_FullMethodName = "/campaigns.v1.CampaignService/ListCampaignLinks"
	CampaignService_GetCampaignStats_FullMethodName  = "/campaigns.v1.CampaignService/GetCampaignStats"
	CampaignService_ExportLinks_FullMethodName       = "/campaigns.v1.CampaignService/ExportLinks"
)
...
type CampaignServiceClient interface {
	...
	ListCampaignLinks(ctx context.Context, in *ListCampaignLinksRequest, opts ...grpc.CallOption) (*ListCampaignLinksResponse, error)
	...
	ExportLinks(ctx context.Context, in *ExportLinksRequest, opts ...grpc.CallOption) (*ExportLinksResponse, error)
}
...
func (c *campaignServiceClient) GenerateLinks(ctx context.Context, in *GenerateLinksRequest, opts ...grpc.CallOption) (*GenerateLinksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateLinksResponse)
	err := c.cc.Invoke(ctx, CampaignService_GenerateLinks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignServiceClient) ListCampaignLinks(ctx context.Context, in *ListCampaignLinksRequest, opts ...grpc.CallOption) (*ListCampaignLinksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListCampaignLinksResponse)
	err := c.cc.Invoke(ctx, CampaignService_ListCampaignLinks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignServiceClient) ExportLinks(ctx context.Context, in *ExportLinksRequest, opts ...grpc.CallOption) (*ExportLinksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExportLinksResponse)
	err := c.cc.Invoke(ctx, CampaignService_ExportLinks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CampaignServiceServer interface {
	...
	// List campaign links with pagination
	ListCampaignLinks(context.Context, *ListCampaignLinksRequest) (*ListCampaignLinksResponse, error)
	// Get campaign statistics
	GetCampaignStats(context.Context, *GetCampaignStatsRequest) (*CampaignStats, error)
	// Export all campaign links
	ExportLinks(context.Context, *ExportLinksRequest) (*ExportLinksResponse, error)
...
func (UnimplementedCampaignServiceServer) GenerateLinks(context.Context, *GenerateLinksRequest) (*GenerateLinksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateLinks not implemented")
}
func (UnimplementedCampaignServiceServer) ListCampaignLinks(context.Context, *ListCampaignLinksRequest) (*ListCampaignLinksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCampaignLinks not implemented")
}
...
func (UnimplementedCampaignServiceServer) ExportLinks(context.Context, *ExportLinksRequest) (*ExportLinksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExportLinks not implemented")
}
...
func _CampaignService_GenerateLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateLinksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CampaignServiceServer).GenerateLinks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CampaignService_GenerateLinks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CampaignServiceServer).GenerateLinks(ctx, req.(*GenerateLinksRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CampaignService_ListCampaignLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListCampaignLinksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CampaignServiceServer).ListCampaignLinks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CampaignService_ListCampaignLinks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CampaignServiceServer).ListCampaignLinks(ctx, req.(*ListCampaignLinksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CampaignService_ExportLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExportLinksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CampaignServiceServer).ExportLinks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CampaignService_ExportLinks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CampaignServiceServer).ExportLinks(ctx, req.(*ExportLinksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CampaignService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "campaigns.v1.CampaignService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CampaignService_GenerateLinks_Handler,
		},
		{
			MethodName: "ListCampaignLinks",
			Handler:    _CampaignService_ListCampaignLinks_Handler,
		},
		{
		...
		{
			MethodName: "ExportLinks",
			Handler:    _CampaignService_ExportLinks_Handler,
		},
	},
